...
using System.Timers;
    ...
    public partial class cexam : System.Web.UI.Page
    {
        ...
        {
            if (RadioButtonList6.SelectedValue == "3")
            {
                ViewState["click"] = (int)ViewState["click"] + 1;
            }
        }
        protected void RadioButtonList7_SelectedIndexChanged1(object sender, EventArgs e)
        {
        ...
        protected void RadioButtonList8_SelectedIndexChanged1(object sender, EventArgs e)
        {
        ...
        protected void RadioButtonList10_SelectedIndexChanged1(object sender, EventArgs e)
        {
