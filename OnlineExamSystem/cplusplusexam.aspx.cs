...
public partial class cplusplusexam : System.Web.UI.Page
{
    ...
    {
        if (RadioButtonList5.SelectedValue == "4")
        {
            ViewState["click"] = (int)ViewState["click"] + 1;
        }
    }
    ...
    {
        if (RadioButtonList7.SelectedValue == "3")
        {
            ViewState["click"] = (int)ViewState["click"] + 1;
        }
    }
    ...
    {
        if (RadioButtonList8.SelectedValue == "4")
        {
            ViewState["click"] = (int)ViewState["click"] + 1;
        }
    }
